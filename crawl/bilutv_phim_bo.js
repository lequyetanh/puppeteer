...
let d = 289;
(async () => {
    for (let x = 145; x <= 149; x++) {
        const browser = await puppeteer.launch();
        const page = await browser.newPage();
        const url = `https://bilutvzz.net/phim-bo//trang-${x}`;
        await page.goto(url);
        ...
        for (let i = 0; i <= 35; i++) {
                ...
                try {
                    ...
                    itemcontainer.map((i) => {
                        ...
                        if (i.querySelector('label').innerText == "Điểm IMDb:") {
                            ...
                            // eachMovie['IMDb_vote'] = i.innerText;
            ...
            // var linkMovie1 = await new2Page.evaluate(() => {
            //     let arrayUrlMovie = [];
            //     let urlMovie = {};

            //     let listEpisode = document.querySelectorAll('.list-episode');

            //     let listVideo0 = listEpisode[0].querySelectorAll('li');
            //     for (let index = 0; index < listVideo0.length; index++) {
            //         arrayUrlMovie.push({
            //             video: "",
            //             episode: listVideo0[index].querySelector('a').innerText,
            //             subtitle: "VIETSUB"
            //         })
            //     }

            //     if (listEpisode[1]) {
            //         let listVideo1 = listEpisode[1].querySelectorAll('li');
            //         for (let index = 0; index < listVideo1.length; index++) {
            //             arrayUrlMovie.push({
            //                 video: "",
            //                 episode: listVideo1[index].querySelector('a').innerText,
            ...
            // var linkMovie2 = await new2Page.evaluate(() => {
            //     let arrayUrlMovie = [];
            //     let urlMovie = {};
            ...
            //     for (let index = 0; index < listVideo0.length; index++) {
            //         arrayUrlMovie.push({
            //             video: listVideo0[index].querySelector('a').getAttribute('href'),
            //             episode: listVideo0[index].querySelector('a').innerText,
            //             subtitle: "VIETSUB"
            //         })
            //     }
            ...
            //     for (let index = 0; index < listVideo1.length; index++) {
            //         arrayUrlMovie.push({
            //             video: listVideo1[index].querySelector('a').getAttribute('href'),
            //             episode: listVideo1[index].querySelector('a').innerText,
            //             subtitle: "Thuyết Minh"
            //         })
            //     }
